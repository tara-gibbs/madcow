...
BOTNAME = 'stackabot'  # will use this nickname in irc/silc and for addressing
...
OWNER_NICK = 'tarabyte'  # in irc/silc/aim set to your name to be given auto-admin
ALLOW_REGISTRATION = False  # allow other users to register with the bot
...
LOGGING_LEVEL = 'ERROR'  # DEBUG, INFO, WARN, ERROR
...
PRIVATE_MODULES = ['lyrics', 'company', 'notes', 'realname', 'xray']  # list of modules (from MODULES above) that only respond in private message
...
IRC_HOST = 'niven.freenode.net'
IRC_PORT = 6697
IRC_SSL = True
IRC_DEBUG = False  # enable for lots of details. noisy!
IRC_PASSWORD = None
IRC_CHANNELS = ['#stackato']
IRC_RECONNECT = True
